{
  azalea.modules.tailscale =
    ...
    in
    {
      imports = [
        (mkAliasOptionModule
          [ "zaphkiel" "services" "tailscale" "authFile" ]
      ...
      config = {
        ...
        systemd.services."tailscaled.service".wants = mkIf (cfg.exitNode.enable) [
          "udp-gro-forwarding.service"
        ];
