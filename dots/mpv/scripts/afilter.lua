...
local sfa_filter = {
  enabled = false,
  syntax = "sofalizer=sofa=\""
    .. mp.command_native({ "expand-path", o.sofa_file })
    .. "\":type="
    .. o.sofa_type
    .. ":gain="
    .. o.sofa_gain
...
local function type_compare(w_list, m_type)
  ...
  elseif
    (w_list == "video")
    and ((m_type == "vidmc") or (m_type == "movie") or (m_type == "movmc"))
  then
    return true
  elseif
    ((w_list == "movie") or (w_list == "vidmc")) and (m_type == "movmc")
  then
    return true
  elseif
    (w_list == "allmc")
    and ((m_type == "audmc") or (m_type == "vidmc") or (m_type == "movmc"))
  then
    return true
  else
    return false
